...
@NamedQueries({
    ...
    @NamedQuery(name = "Pago.pagosPorEstudiante", query = "SELECT p FROM Pago p WHERE p.estudianteidEstudiante = :idEstudiante order by p.cicloidCiclo,p.cuota,p.montoSaldo DESC,p.fechaRegPago")
})
